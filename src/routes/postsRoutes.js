...
import { listarPosts, postarNovoPost, uploadImagem } from "../controllers/postsController.js";  // Importando funções específicas do controlador de posts para lidar com as operações de listar posts, criar novos posts e fazer upload de imagens
...
const routes = (app) => {
    ...
    app.post("/upload", upload.single("imagem"), uploadImagem) // Chama a função
}
